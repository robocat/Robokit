Pod::Spec.new do |s|
  ...
  s.subspec 'Shared' do |ss|
    ss.source_files =         'Robokit/Source/{Robokit,RKMacros,RKDispatch,RKLocalization,RKSocial,RKRatingViewController,RKFollowUsViewController,RKDialogViewController,UIViewController+Robokit}.{h,m}',
